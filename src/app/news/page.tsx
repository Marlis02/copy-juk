    ...
    <div>
      {newsItems.map((items) => {
        return (
          ...
          <div className={styles.globalContainer}>
            <Image className={styles.image} width={625} height={375} src={items.image} alt='img'/>
      ...
      <div className={styles.buttonVector}>
        <div className={styles.buttonVectorDiv}>
          <button><Image className={styles.images} width={25} height={15} alt="logo" src="/icons/iconLeft.svg" /></button>
            <h5>1</h5>
            <h5>2</h5>
            <h5>3</h5>
            <h5>4</h5>
            <h5>5</h5>
          <button><Image className={styles.images} width={25} height={15} alt="logo" src="/icons/iconRight.svg" /></button>
        </div>
      </div>
    </div>
  )
